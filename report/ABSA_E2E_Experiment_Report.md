...
**In-domain restaurant (1 vs. 2):** DeBERTa improves ATE F1 (**0.5759** vs. **0.5608**) and gold ASC accuracy (**0.842** vs. **0.8304**). For predicted aspects, BERT achieves slightly higher ASC accuracy (**0.8483** vs. **0.8405**) but lower macro-F1 (**0.7589** vs. **0.7288**), highlighting a **metric-dependent** comparison.
